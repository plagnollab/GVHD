...
infile = read.csv(paste("/cluster/project8/vyp/Winship_GVHD/claire/results/LC_array_analysis/", choice, ".csv", sep = ""), header = TRUE)
...
pdf(paste("/cluster/project8/vyp/Winship_GVHD/claire/results/syn_allo_bmt/figs/", choice, "_histogram.pdf", sep = ""))
