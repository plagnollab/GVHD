...
write.csv(x= tab.annotated, file = paste('/cluster/project8/vyp/Winship_GVHD/claire/GVHD/array_analysis/syn_allo_bmt/results/', choice,'.csv',sep =""))
write.csv(x= significant, file = paste('/cluster/project8/vyp/Winship_GVHD/claire/GVHD/array_analysis/syn_allo_bmt/results/', choice,'_significant.csv',sep =""))
