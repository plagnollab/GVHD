...
write.csv(x= significant_TM006, file = paste('array_analysis/MHC1_KO/results/DE_D42WT_VS_D42KO_ALLANALYSIS_TM006.csv',sep =""))
write.csv(x= non_significant_TM006, file = paste('array_analysis/MHC1_KO/results/non_DE_D42WT_VS_D42KO_ALLANALYSIS_TM006.csv',sep =""))
write.csv(x= significant_TM008, file = paste('array_analysis/MHC1_KO/results/DE_D7WT_VS_D7KO_ALLANALYSIS_TM008.csv',sep =""))
write.csv(x= non_significant_TM008, file = paste('array_analysis/MHC1_KO/results/non_DE_D7WT_VS_D7KO_ALLANALYSIS_TM008.csv',sep =""))
