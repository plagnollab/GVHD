...
png("/cluster/project8/vyp/Winship_GVHD/claire/results/mhc1_ko/D7_histogram.png")

hist(TM008_no_outlier$P.Value, breaks=seq(0, 1, by=0.02), main = "Histogram of D7 (TM008) MHC1-KO vs WT p-values", xlab = "p-value" )
dev.off()

png("/cluster/project8/vyp/Winship_GVHD/claire/results/mhc1_ko/D42_histogram.png")
