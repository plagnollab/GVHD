...
########## list of DE genes
DE <- read.csv(paste("/cluster/project8/vyp/Winship_GVHD/claire/GVHD/array_analysis/MHC1_KO/results/DE_", choice, ext,  ".csv", sep = ""), sep = ",", header = TRUE)
...
nonDE <- read.csv(paste("/cluster/project8/vyp/Winship_GVHD/claire/GVHD/array_analysis/MHC1_KO/results/non_DE_", choice, ext, ".csv", sep = ""), sep = ",", header = TRUE)
...
write.table(table.results, file = paste("/cluster/project8/vyp/Winship_GVHD/claire/GVHD/array_analysis/MHC1_KO/results/immgen_association/", choice, "_ImmGen_fine__module_association_Fishers_exact_test_Pvalues.txt", sep = ""), sep = "\t")
...
write.table(final.table, file = paste("/cluster/project8/vyp/Winship_GVHD/claire/GVHD/array_analysis/MHC1_KO/results/immgen_association/", choice, "_final_table_fine.txt", sep = ""), sep = "\t")
...
pdf(paste("/cluster/project8/vyp/Winship_GVHD/claire/GVHD/array_analysis/MHC1_KO/results/immgen_association/", choice, "_fine_module_association_graph.pdf", sep = ""))
