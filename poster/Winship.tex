...
\mode<presentation>
  ...
  \end{beamercolorbox}
    ...
    \begin{columns}[t]
	  ...
	  %\begin{center}
	  %  \includegraphics[width=25cm]{/cluster/project8/vyp/Winship_GVHD/claire/results/mhc1_ko/figs/PCA_prettier_outlier_removed.pdf}
	  %\end{center} %this is the small section of code I tried to use to plot the two plots adjacent to one another
	 % \begin{figure}
	 % \subfloat{/cluster/project8/vyp/Winship_GVHD/claire/results/mhc1_ko/figs/D7_histogram.pdf} \qqaud 
	 % \subfloat{/cluster/project8/vyp/Winship_GVHD/claire/results/mhc1_ko/figs/PCA_prettier_outlier_removed.pdf}
	 % \end{figure} 
          \begin{itemize}
          \item some items
          \item some items
